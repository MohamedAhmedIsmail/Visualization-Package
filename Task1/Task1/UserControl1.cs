...
namespace Task1
{
    public partial class UserControl1: UserControl
    {
        ...
        public Tuple<double, double, double> ValueToColorDiscrete(double S_min, double S_max, double Value)
        {
            double red = 0, green = 0, blue = 0;
            double i = Math.Floor(6 * ((Value - S_min) / (S_max - S_min)));
            ...
            return Tuple.Create(red / 255, green / 255, blue / 255);

        }
        public Tuple<double, double, double> ValueToColorContinuous(double S_min, double S_max, double Value)
        {
            if (Value > S_max)
            {
                Value = S_max;
            ...
            double deltaS = 4.0 * ((double)(Value - S_min) / (S_max - S_min));
            int index = (int)deltaS;
            double alpha = deltaS - index;
        ...
        public void main_canvas_Paint(object sender, PaintEventArgs e)
        {
            var g = main_canvas.CreateGraphics();
            if (checkBox1.Checked == true)
            {
                var a1 = new LinearGradientBrush(new Rectangle(0, 0, 90, 50),
                   Color.Blue,
                   Color.Orange,
                   LinearGradientMode.Horizontal);
                g.FillRectangle(a1, new Rectangle(0, 0, 90, 50));

                var a2 = new LinearGradientBrush(new Rectangle(90, 0, 90, 50),
                  Color.Orange,
                  Color.FromArgb(0, 255, 0),
                  LinearGradientMode.Horizontal);
                g.FillRectangle(a2, new Rectangle(90, 0, 90, 50));

                var a3 = new LinearGradientBrush(new Rectangle(180, 0, 90, 50),
                  Color.FromArgb(0, 255, 0),
                  Color.Yellow,
                  LinearGradientMode.Horizontal);
                g.FillRectangle(a3, new Rectangle(180, 0, 90, 50));
                var a4 = new LinearGradientBrush(new Rectangle(270, 0, 90, 50),
                  Color.Yellow,
                  Color.Cyan,
                  LinearGradientMode.Horizontal);
                g.FillRectangle(a4, new Rectangle(270, 0, 90, 50));

                var a5 = new LinearGradientBrush(new Rectangle(360, 0, 90, 50),
                  Color.Cyan,
                  Color.Red,
                  LinearGradientMode.Horizontal);
                g.FillRectangle(a5, new Rectangle(360, 0, 90, 50));

            }
            if (checkBox2.Checked==true)
            {
                g.DrawRectangle(Pens.Blue, new Rectangle(0, 0, 75, 50));
                g.FillRectangle(Brushes.Blue, new Rectangle(0, 0, 75, 50));

                g.DrawRectangle(Pens.Orange, new Rectangle(75, 0, 75, 50));
                g.FillRectangle(Brushes.Orange, new Rectangle(75, 0, 75, 50));

                var b = new LinearGradientBrush(new Rectangle(150, 0, 75, 50), Color.FromArgb(0, 255, 0),
                     Color.FromArgb(0, 255, 0),
                     LinearGradientMode.Horizontal);
                g.FillRectangle(b, new Rectangle(150, 0, 75, 50));

                g.DrawRectangle(Pens.Yellow, new Rectangle(225, 0, 75, 50));
                g.FillRectangle(Brushes.Yellow, new Rectangle(225, 0, 75, 50));

                g.DrawRectangle(Pens.Cyan, new Rectangle(300, 0, 75, 50));
                g.FillRectangle(Brushes.Cyan, new Rectangle(300, 0, 75, 50));

                g.DrawRectangle(Pens.Red, new Rectangle(375, 0, 75, 50));
                g.FillRectangle(Brushes.Red, new Rectangle(375, 0, 75, 50));
